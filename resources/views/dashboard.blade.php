                            ...
                            <div class="list-group-item">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <!-- Avatar -->
                                        <a href="project-overview.html" class="avatar avatar-4by3">
                                            <img src="{{ asset('dashkit/src/assets/img/avatars/projects/project-5.jpg')}}" alt="..." class="avatar-img rounded">
                                        </a>
                                    ...
                                    <td class="text-right">
                                        <div class="avatar-group">
                                            ...
                                            <a href="profile-posts.html" class="avatar avatar-xs" data-toggle="tooltip" title="" data-original-title="Ab Hadley">
                                                <img src="{{ asset('dashkit/src/assets/img/avatars/profiles/avatar-2.jpg')}}" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="profile-posts.html" class="avatar avatar-xs" data-toggle="tooltip" title="" data-original-title="Adolfo Hess">
                                                <img src="{{ asset('dashkit/src/assets/img/avatars/profiles/avatar-3.jpg')}}" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="profile-posts.html" class="avatar avatar-xs" data-toggle="tooltip" title="" data-original-title="Daniela Dewitt">
                                                <img src="{{ asset('dashkit/src/assets/img/avatars/profiles/avatar-4.jpg')}}" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <div class="avatar avatar-sm avatar-online">
                                            <img class="avatar-img rounded-circle" src="{{ asset('dashkit/src/assets/img/avatars/profiles/avatar-1.jpg')}}" alt="..." />
                                        </div>
                            ...
                            <div class="list-group-item">
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <!-- Avatar -->
                                        <div class="avatar avatar-sm avatar-online">
                                            <img class="avatar-img rounded-circle" src="{{ asset('dashkit/src/assets/img/avatars/profiles/avatar-2.jpg')}}" alt="..." />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <div class="avatar avatar-sm avatar-offline">
                                            <img class="avatar-img rounded-circle" src="{{ asset('dashkit/src/assets/img/avatars/profiles/avatar-3.jpg')}}" alt="..." />
                                        </div>
